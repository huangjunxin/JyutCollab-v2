...
const emptyAISuggestionStats = (): AISuggestionStats => ({
  ...
  rejectionRate: 0,
  byType: [
    { type: 'definition', label: '釋義', total: 0, pending: 0, accepted: 0, rejected: 0, modified: 0, acceptanceRate: 0, modificationRate: 0, rejectionRate: 0 },
    { type: 'theme_classification', label: '分類', total: 0, pending: 0, accepted: 0, rejected: 0, modified: 0, acceptanceRate: 0, modificationRate: 0, rejectionRate: 0 },
    { type: 'example', label: '例句', total: 0, pending: 0, accepted: 0, rejected: 0, modified: 0, acceptanceRate: 0, modificationRate: 0, rejectionRate: 0 }
  ]
})
