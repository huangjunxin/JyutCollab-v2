...
describe('Entries desktop table regression guards', () => {
  ...
  it('keeps desktop AI theme and register suggestions visible after async generation', () => {
    ...
    expect(desktopTableSource).not.toContain(':ai-suggestion-hint="getCellAISuggestionHint(')
    ...
    expect(desktopTableSource).not.toContain('@accept-ai-suggestion="acceptCellAISuggestion(')
    expect(desktopTableSource).not.toContain('@dismiss-ai-suggestion="dismissCellAISuggestion(')
